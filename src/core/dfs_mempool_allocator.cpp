...
static int dfs_mempool_allocator_init(dfs_mem_allocator_t *me, 
	                                           void *param_data)
{
    dfs_mempool_allocator_param_t *param = nullptr;
...
{
    dfs_mempool_allocator.private_data = nullptr;
    ...
    dfs_mempool_allocator.free         = nullptr;
    dfs_mempool_allocator.strerror     = dfs_mempool_allocator_strerror;
    dfs_mempool_allocator.stat         = nullptr;
