...
int  epoll_add_event(event_base_t *ep_base, event_t *ev, int event, uint32_t flags); /* add an event */
int  epoll_del_event(event_base_t *ep_base,event_t *ev, int event, uint32_t flags); /* delete an event */
