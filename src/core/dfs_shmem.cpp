	                                   ...
	                                   size_t factor, unsigned int *shmem_errno)
{
    ...
    *shmem_errno = DFS_SHMEM_ERR_NONE;
    ...
    shm = (dfs_shmem_t*)mmap(nullptr, total_size,
...
{
    struct free_node *free1 = nullptr;
    struct free_node *free = nullptr;
    queue_t          *q = nullptr;
    size_t            index = 0;
    int               flag = 1;
...
{
    struct storage   *st = nullptr;
    struct storage   *st_new = nullptr;
    struct free_node *free = nullptr;
    queue_t          *q = nullptr;
    queue_t          *st_q = nullptr;
    int               found_st = 0;
    int               no_free = 1;
    size_t            index = 0;
