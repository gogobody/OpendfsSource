...
{
    faio_errno_t             error;
    faio_notifier_manager_t *faio_noty = nullptr;
...
{
    file_io_t *file_task = nullptr;
    int        ret = 0;
	//会生成一个类型为 size_t 的整型常量，它是一个结构成员相对于结构开头的字节偏移量。
...
// setup parse func and done func
