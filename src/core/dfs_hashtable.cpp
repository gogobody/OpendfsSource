...
{
    size_t                i = 0;
    dfs_hashtable_link_t *walker = nullptr;
 ...
 *  in the hash table 'hid'. Otherwise, returns nullptr on error.
 */
	                                  ...
	                                  void *param)
{
	size_t                i = 0;
	dfs_hashtable_link_t *walker = nullptr;
	dfs_hashtable_link_t *next = nullptr;
